...
const DEFAULT_RESET_PASSWORD_FORM_TEMPLATE = path.resolve(__dirname, './templates/ResetPasswordForm.ejs');
const DEFAULT_CONFIRM_EMAIL_TEMPLATE = path.resolve(__dirname, './templates/ConfirmEmail.ejs');
const DEFAULT_RESET_PASSWORD_TEMPLATE = path.resolve(__dirname, './templates/ResetPassword.ejs')
