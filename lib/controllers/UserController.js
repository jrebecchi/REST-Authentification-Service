...
exports.postCreateUser = function (req, res, next) {
    ...
    User.userExists({ username: user.username })
        ...
        .then(() => {
            ...
            return sendConfirmationEmail(req, user.email, user.emailConfirmationCode, req.headers.host, error)
        })
        .then(() => {
...
const sendConfirmationEmail = (req, email, confirmationToken, host, error) => {
